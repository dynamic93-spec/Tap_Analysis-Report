...
export default function AnalysisSystem({ selectedItem, onClose, onSave }: AnalysisSystemProps) {
  ...
  const [fixedTabs] = useState<string[]>(['사업성', '팀역량', '기술성', '시장성', '지식재산권', '글로벌 진출 역량']);
